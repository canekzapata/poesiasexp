...
- **IA**: elige motor (**Claude / ChatGPT / HuggingFace**) y un modo de taller
  (**Libre / Arquitecto narrativo / Crítico editorial / Editor de línea**), escribe tu petición y
...
- En **Arquitecto narrativo**, la IA propone estructura, arcos, conflictos y siguientes pasos.
- En **Crítico editorial**, prioriza problemas de ritmo, voz, personajes y continuidad.
- En **Editor de línea**, propone cambios concretos conservando el registro del texto.
- Los modos de taller solo producen propuestas: nada modifica el manuscrito hasta que pulses
  **insertar respuesta en editor**.
