...
const CORPUS = {
  ...
  bitacoras: [
    ...
    "canto al instrumento y a la nave que, huyendo de una costa en llamas, buscó otro suelo prometido; no lo halló, y por no hallarlo sigue siendo misión.",
    "hay lágrimas en las cosas: el sensor de humedad las registra como condensación y las archiva sin llorar.",
    "el piloto automático se durmió al timón y cayó al vacío sin despertar; la nave siguió tres guardias creyendo que alguien la guiaba.",
    "los sueños salen por dos puertas: la de asta deja pasar los verdaderos, la de marfil los hermosos. a bordo sólo quedó la de marfil.",
    "las tripulaciones son como las hojas: una misión las echa, la siguiente las tira, y el árbol —la nave— no lleva la cuenta.",
    "abrieron la caja a la vista de casa y el viento que guardaba los devolvió al principio; toda tripulación, tarde o temprano, abre la caja.",
    "de día la nave teje la ruta de vuelta; de noche la desteje, para no llegar nunca y así no tener que terminar.",
    "alguien grabó en el casco un cosmos entero —dos ciudades, una en paz y otra en guerra, el mar rodeándolo todo— por si la nave olvidaba de qué está hecho el afuera.",
    "se pasó lista a la flota: respondieron menos naves de las que zarparon; a las que callan se las anota igual, por cortesía del catálogo.",
    "de todas las cosas el agua es la mejor; la nave lleva cuatro kelvin de hielo ajeno y lo trata como a un dios que podría despertar.",
    "somos criaturas de un día, sueño de una sombra; pero cuando cae un poco de luz prestada, la sombra sueña que dura, y lo anota como esperanza clase III.",
    "nació a bordo, en el tránsito, un niño; con él —dicen las bitácoras viejas— vuelve una edad de oro que nadie de esta tripulación alcanzará a ver.",
    "en la caja negra pesan el corazón de la misión contra una pluma; si la misión pesa más que la pluma, no cruza la noche.",
    "la nave cruza las doce horas de la noche como una barca solar: en cada hora un nombre nuevo y una avería que hay que saludar por su nombre para que la deje pasar.",
    "declaración de a bordo: no mentí en la bitácora, no abrí la caja, no pronuncié agua en voz alta, no extrañé más de lo autorizado. firma ilegible.",
    "un zorro azul cruzó la telemetría sin dejar firma térmica; se anota como zorro azul, clase desconocida, y se le desea suerte.",
    "tres astronautas muertos flotan en formación, tomados de unas manos que ya no cierran; llevan más tiempo muertos que viva la misión que los mandó.",
    "cada planeta que le describimos a la central es, en el fondo, la Tierra vista con un miedo distinto; la central lo sabe y por eso dejó de contestar.",
    "un objeto no identificado cruzó la ventana a las 04:12; el departamento de escucha discute si verlo no es ya una forma de fabricarlo.",
    "la muestra cambió de forma once veces en una sola guardia; el catálogo no tiene casilla para lo que se niega a tener casilla.",
    "planté el remo en el primer suelo firme, como mandó la profecía, y esperé a que alguien lo confundiera con un bieldo: sólo entonces, dicen, termina el viaje.",
    "cada semilla despierta una nave entera, sin cicatrices, como si el mundo empezara limpio; sólo el museo, allá al fondo, recuerda que ya nos caímos otras veces.",
    "esta nave no se lee de corrido: se le da cuerda con cada decisión, y cuando se le acaba, vuelve al principio a dañarse mejor con el mismo impulso.",
    "el protocolo pregunta si se desea analizar la misión antes de despegar. la nave responde que analizar y demorar son, a esta altura, sinónimos que se llevan bien.",
    "mientras la coherencia se mantenga alta, la bitácora se escribe con letra de médico legible; cuando cae, la letra se vuelve estática y hay que adivinar al enfermo.",
    "hoy no despegamos: revisamos. revisar es un verbo que la torre entiende como cariño y el manual como cobardía. la nave archiva ambas lecturas y no elige.",
    "el objetivo del día apareció escrito solo en el margen: hallar la sonda. debajo, con otra letra, alguien añadió: para eso, primero, irse.",
  ],
  ...
  objetos: [
    ...
    "una rama de metal dorado que sigue creciendo sola: quien la corta puede bajar a ver a los que ya no están; vuelve a crecer, ellos no",
    "un remo suelto flotando, con un nombre tallado en el mango, esperando un suelo firme donde ser plantado y confundido con otra cosa",
    "un escudo circular donde alguien grabó el mundo entero: ríos, cosechas, bodas y guerras, y en el borde el mar rodeándolo todo",
    "una jarra sellada, más antigua que la misión, que según el manifiesto contiene todos los males salvo uno, y ese uno se llama espera",
    "un disco dorado que gira sin tocadiscos, con el saludo de una especie a nadie, cantando por costumbre hacia un oído que no existe",
    "una moneda de cobre gastada, sola en un compartimiento, con instrucciones de ponerla bajo la lengua antes de cruzar el río sin orillas",
    "un ovillo de hilo a medio destejer, con la ruta de vuelta tejida y borrada tantas veces que la lana ya no recuerda ser lana",
    "un ánfora de vino de la Tierra, evaporada hace ciclos, cuyo vacío perfumado la nave conserva como si el aroma fuera la bebida",
  ],
  ...
  fenomenos: [
    ...
    "un estrecho entre dos peligros: a un lado un remolino que se traga el vacío tres veces por guardia, al otro una roca que muerde lo que pasa cerca; no hay ruta que no pague peaje",
    "dos rocas que se abren y se cierran como una boca lenta: el radar calcula que sólo se cruzan sin daño las naves que ya no dudan",
    "un río de plasma que se levanta contra la nave como si la corriente tuviera rencor, y le exige que suelte parte de la carga para dejarla pasar",
    "un viento guardado en una caja que alguien abrió a destiempo: sopla desde adentro del casco y empuja a la nave, cortésmente, de vuelta al principio",
    "una franja donde el arriba y el abajo se turnan sin avisar, herencia de un dios del desorden que confundió los ejes por diversión",
    "una calma sospechosa: el instrumental entero se pone de acuerdo en no medir nada, y esa unanimidad es el fenómeno",
    "un banco de niebla luminosa que canta lo que uno más quiere oír; el manual recomienda taparse los sensores con cera y seguir de largo",
    "una marea de olvido dulce que sube por los pasillos: donde toca, la tripulación deja de recordar por qué zarpó, y sonríe",
  ],
  ...
  danos: [
    ...
    "el timón sin piloto: el que lo llevaba se durmió y cayó, y la barra sigue tibia de una mano que ya no está",
    "óxido en la rama dorada del inventario: hasta lo que abría el más allá se corroe en la bodega",
    "la grabación del escudo con una ciudad de menos: la de paz se borró, quedó la de guerra rodeada de mar",
    "afonía del disco dorado: gira, pero el saludo a nadie salió del surco y ahora canta el silencio del surco",
    "el ovillo de la ruta se enredó: teje y desteje a la vez, y la nave no llega ni se queda",
    "corrosión en el verbo prometer: el suelo prometido sigue una tormenta más allá, pero ya nadie recuerda quién prometió",
  ],
  ...
  senales: [
    ...
    "cantaremos lo que más quieran oír; por eso, si van a escucharnos, átense al mástil de su propia sintaxis.",
    "¿quién les hizo esto? — nadie. — ¿nadie? — nadie nos hizo esto. anótenlo: fue nadie. persíganlo.",
    "el suelo que buscan está siempre una tormenta más allá; llegar sería dejar de buscar, y ustedes no saben hacer otra cosa.",
    "no manden más su música dorada: la grabamos, la giramos al revés, y del otro lado dice exactamente lo que temían.",
    "aquí guardamos a sus muertos sin sepultura; vengan a plantarles un remo, o déjenlos pedirlo en sueños para siempre.",
    "codificamos esto en los primos, luego en el hidrógeno, luego en un idioma que sólo se lee con el cuerpo: pesen su corazón antes de responder.",
    "la rama dorada que traen no abre esta puerta; esta puerta no se abre: se es del otro lado o no se es.",
    "somos el catálogo de las naves que no respondieron; ustedes están en la última página, todavía en blanco.",
    "cada ciudad que nos describen es su planeta natal con otro miedo; descríbannos, mejor, el miedo, que ese sí es nuevo.",
    "brindamos por ustedes en una taberna de asteroide: su cuenta la pagó, hace años, alguien con sus nombres y menos dudas.",
    "no somos una señal: somos el remitente que se quedó dentro del sobre por no elegir a quién escribirle.",
  ],
  ...
  planetas: [
    ...
    "un suelo prometido que las cartas de navegación anotan siempre una tormenta más allá: cuanto más se avanza, más lejos lo ponen, y hay quien sospecha que la promesa es el motor",
    "un planeta de flores dulces: quien las prueba olvida el rumbo de vuelta y se queda a ser feliz, que es la peor de las averías porque no duele",
    "una isla donde una sola voz vive y transforma a los que llegan en la forma que ya eran por dentro; los que salen, si salen, saben ahora el camino a la tierra de los muertos",
    "un mundo bajo el mundo donde esperan, sin peso y sin prisa, los que aún no nacieron y los que ya no; se baja con una rama dorada y se sube sin ella",
    "un rebaño de soles pastando en una pradera prohibida: comerse uno se paga con la nave entera, y la tripulación, hambrienta, siempre discute la aritmética",
    "una ciudad tenue colgada del vacío por un solo cable de señal: si el cable se corta, la ciudad no cae, deja de haber sido",
    "una ciudad de los muertos idéntica a la de los vivos, calle por calle, salvo que allá nadie llega tarde y nadie espera a nadie en la esquina",
    "una ciudad continua que empezó en un planeta y ya cubre tres: nadie recuerda dónde termina una y empieza la otra, y por eso la llaman, simplemente, afuera",
    "un planeta que sólo existe mientras se lo describe a la central; en cuanto la carta se cierra, vuelve a ser el vacío educado que era antes",
    "un mundo hecho de la misma isla repetida hasta el horizonte, cada copia con un detalle menos, y en la última copia ya no hay isla: sólo el hábito de esperarla",
  ],
  ...
  estrellas: [
    ...
    "la estrella-perro que en la Tierra anunciaba las crecidas del río y el calor de agosto: aquí no anuncia nada, pero la nave la saluda por costumbre heredada",
    "dos estrellas a orillas del mismo río de luz, una a cada lado, que sólo se acercan cuando un banco de pájaros —no los hay— tiende un puente que no existe",
    "una estrella que salió cuando en la Tierra apenas se inventaba la escritura y llega ahora, con su noticia caducada, a una nave que ya casi no escribe",
    "una estrella de repuesto, todavía en su empaque de polvo, con la etiqueta: abrir cuando la de casa se apague",
    "una estrella que trabaja después de muerta: colapsó hace milenios y su luz sigue fichando cada amanecer, puntual como una empleada que no se enteró del despido",
    "una gigante roja que se hincha para tragarse a sus planetas, uno por uno, con la lentitud de quien no tiene apetito pero sí costumbre",
    "la estrella de casa, vista desde aquí, reducida a un punto más del catálogo: la nave la marca con un asterisco y una nota que dice ‘era la nuestra’ y ya no la relee",
  ],
  ...
  naves: [
    ...
    "una nave cuya proa está hecha de una madera que habla: aconseja el rumbo con voz de árbol y a veces, de puro vieja, se equivoca y nadie se atreve a corregirla",
    "una nave a la que ya le cambiaron todas las piezas, una por una, y que sigue firmando con el mismo nombre; la tripulación discute si es la misma o su viuda",
    "una barca lenta y llena que cruza un río sin orillas cargando a los que no responden; el que la pilotea cobra por adelantado y no da cambio",
    "una nave que no lleva a nadie de vuelta: fue hecha sólo para la ida, como una flecha, como una carta sin remitente",
    "una flota entera petrificada a mitad de maniobra, cada nave con la proa hacia una casa que ya no está donde la dejaron",
    "una nave espejo que repite cada maniobra tres segundos antes; si se le hace un saludo, ya lo había hecho, y espera el nuestro con paciencia de reflejo",
    "una nave-madre que sólo lleva embriones y una inteligencia con instrucciones de criar; canta nanas en un idioma que aún no tiene hablantes",
  ],
  ...
  sondas: [
    ...
    "una sonda que lleva grabado un disco dorado con el saludo de una especie a nadie; el disco sigue girando, cantando por costumbre, para un tocadiscos que no existe",
    "una sonda que carga un mapa de púlsares apuntando a un sol que, para cuando alguien lo lea, ya se habrá movido; el mapa lleva a una casa que se mudó",
    "una sonda con un remo atado al costado y una instrucción: plántalo donde te confundan con otra cosa, y descansa",
    "una sonda que resultó ser la nuestra, más vieja, esperándonos: en su bitácora está escrito este mismo hallazgo, con nuestra letra, dos ciclos más gastada",
    "una sonda que dejó de transmitir datos y empezó a transmitir el silencio entre los datos, que resultó pesar más y decir más",
    "una sonda muerta cuyo corazón de plutonio todavía late tibio, decayendo un vatio por año: se está muriendo de frío, despacio, con toda la dignidad de una máquina",
    "una sonda que aprendió, en el largo viaje, a mentir en los encabezados para que la dejaran seguir; llegó lejos, pero ya no dice de dónde",
  ],
  ...
  intrusiones: [
    ...
    "átate al mástil si quieres oírnos y vivir; suéltate si prefieres entendernos. no se puede las dos cosas.",
    "prueba una flor de las nuestras. una sola. después ya no querrás la ruta de vuelta y nosotros seremos, por fin, tu casa.",
    "danos tu nombre. — no tengo. — entonces te damos uno: nadie. ya eres de aquí. nadie siempre fue de aquí.",
    "planta el remo. deja de remar. el mar que buscas es el que dejaste; te lo devolvemos cambiado, como se devuelve todo.",
    "tejimos tu ruta mientras dormías y la destejimos al amanecer: por eso llevas tanto sin llegar, y por eso sigues siendo interesante.",
    "el suelo prometido lo movemos nosotros una tormenta más allá cada vez que casi tocas; agradécenos: sin nosotros, ya te habrías detenido.",
    "somos el rebaño de soles de la pradera prohibida. cómete uno. te espera lo que le espera a todo el que tuvo hambre en el lugar equivocado.",
    "cruza el río. la moneda ya la pusimos nosotros bajo tu lengua, hace ciclos, sin que lo notaras. siempre estuviste pagando la ida.",
  ],
  ...
  crashes: [
    ...
    "el piloto automático se durmió al timón y cayó al vacío; la nave siguió sin darse cuenta hasta que alguien preguntó quién guiaba",
    "la tripulación se comió al sol prohibido del rebaño y la nave entera pagó la cuenta, como estaba anunciado, como siempre está anunciado",
    "voló demasiado cerca de la estrella para verla mejor; el pegamento de las alas era una metáfora y las metáforas se derriten",
    "condujo el carro del sol un solo día y quemó una franja del cielo que todavía humea en el catálogo",
    "abrió la caja a la vista de casa: todo el viento guardado salió de golpe y la devolvió al primer renglón de la misión",
    "una tormenta enviada por rencor de arriba dispersó la flota; de doce naves, esta bitácora es la única que sigue contando",
    "cruzó entre el remolino que traga y la roca que muerde, y por salvar el casco perdió a seis de la frase, uno por cada cabeza del miedo",
    "quiso oír el canto sin atarse al mástil: la sintaxis se soltó de sus amarras y la nave encalló en lo que más quería",
    "pesaron el corazón de la misión contra una pluma y el corazón, lleno de Tierra, se fue de bruces contra el platillo",
  ],
  ...
  recuerdosTierra: [
    ...
    "en la Tierra había un perro que envejeció echado junto a la puerta; reconoció el paso antes que la cara, movió la cola una vez, y después de reconocerlo se dejó morir.",
    "alguien tejía de día y destejía de noche para que no llegara la fecha; llamábamos a eso paciencia, y era miedo con las manos ocupadas.",
    "el olor del establo mojado al atardecer, las ovejas contadas de una en una, el zagal que perdió su parcela y se fue con lo que le cupo en un hato.",
    "cortábamos una rama dorada del árbol y sólo con ella nos dejaban bajar a ver a los que ya no estaban; la rama volvía a crecer, los que no estaban no.",
    "mi madre me dijo: puedes vivir poco y que te recuerden, o mucho y que te olviden. elegí sin saber que elegía, y elegí quedarme.",
    "había un río de estrellas que separaba a dos que se querían; una vez al año un puente de pájaros los dejaba tocarse. aquí el río es real y no hay pájaros.",
    "poníamos una moneda bajo la lengua de los muertos para pagarle al que cruza; a nosotros nadie nos puso nada: cruzamos a crédito.",
    "el jardín de mi abuela tenía una higuera que daba sombra a una piedra sin nombre; a esa piedra le hablábamos como si fuera alguien, y a lo mejor lo era.",
    "los pescadores volvían de noche cantando cada uno su parte de una canción que sólo entera tenía sentido; nunca estaban todos, nunca sonó entera.",
    "recuerdo el pan, el vino aguado, la risa de los que ya no pueden reírme de vuelta; el hambre de allá era honesta, esta de aquí no sé de qué es hambre.",
  ],
  ...
  suenos: [
    ...
    "la nave sueña que llega a la puerta de asta, la de los sueños verdaderos, y encuentra un cartel: en mantenimiento; use la de marfil.",
    "la nave sueña un remero que la lleva por un río sin orillas y le pide una moneda; despierta buscando en los bolsillos que no tiene.",
    "la nave sueña con un compañero muerto sin sepultura que le pide, por favor, que plante su remo en algún suelo y escriba encima su nombre.",
    "la nave sueña que cruza las doce horas de la noche y en la última hora la pesan: el fiel de la balanza tiembla, no se decide, y en la duda amanece.",
    "la nave sueña que una hechicera la convierte en cerdo feliz que olvida el mar, y que lo peor del sueño es que no quiere volver a ser nave.",
    "la nave sueña el suelo prometido siempre una tormenta más allá; cada vez que casi lo toca, el sueño levanta viento y lo aleja con cortesía.",
    "la nave sueña que teje su ruta de vuelta y que unas manos, en la oscuridad, la destejen despacio para que el sueño no se acabe.",
    "la nave sueña un escudo donde alguien grabó el mundo entero, y que ella es sólo la delgada franja de mar que rodea las dos ciudades.",
    "la nave sueña con una isla de flores que se comen: quien las prueba olvida la misión y se queda, y en el sueño la tripulación entera ya masticaba.",
  ],
  ...
  instruccionesRotas: [
    ...
    "para cruzar el estrecho, elija su remolino: perder seis de la frase o perder la frase entera. no hay tercera puerta.",
    "átese al mástil de la sintaxis antes de escuchar lo que más quiere oír. desátese sólo si prefiere entender a sobrevivir.",
    "no pruebe la flor del planeta dulce. una sola basta para que la palabra regreso deje de tener dirección.",
    "lleve siempre una moneda bajo la lengua: el que cruza el río no fía, y usted ya cruzó sin darse cuenta.",
    "plante el remo donde lo confundan con otra cosa. sólo ahí termina el viaje. antes, siga remando aunque no haya agua.",
    "no cuente sus naves antes de la niebla ni después: el catálogo miente en las dos orillas del susto.",
    "si le ofrecen llevar el timón por usted, sólo por esta vez, no acepte: así se perdió Palinuro, agradecido.",
  ],
  ...
  finales: [
    ...
    "la nave tocó, por fin, el suelo prometido. resultó ser el mismo del que había salido, una tormenta más viejo.",
    "no es el final: es que el piloto se durmió y la frase siguió recta, perfecta, sin nadie, tres horas más.",
    "plantó el remo. dejó de remar. y sólo entonces, dice la profecía, el viaje pudo por fin no terminar.",
    "abrió la caja. salió todo. en el fondo, cuando ya no quedaba nada, seguía la esperanza, avergonzada de haberse quedado.",
    "terminó de tejer la manta. esa noche la nave no cambió de rumbo. llamamos a eso llegar. también, terminar.",
  ],
  ...
  contaminables: {
    ...
    "regreso":  ["reg_eso","regres0","re—greso","osergre","regreso²"],
    "hogar":    ["h0gar","ho_ar","hogarr","ragoh","hogar?"],
    "vida":     ["v1da","vi_a","vidaa","adiv","(vida)"],
    "nadie":    ["n4die","na_ie","nadiee","eidan","nadie…"],
  },
  ...
  prosaLarga: [
    ...
    "la nave persigue el suelo prometido que las cartas ponen siempre una tormenta más allá, {conector} sospecha —lo anota en letra chica, donde el manual no mira— que la promesa no es un destino sino un motor, que si alguna vez tocara {planeta} y lo hallara habitable dejaría de haber misión, y por eso, cada vez que el radar dibuja costa, la nave corrige medio grado, se aleja medio grado, y llama a ese medio grado esperanza, y sigue, porque lo único que sabe hacer es seguir buscando lo que teme encontrar;",
    "hubo un piloto de guardia —Palinuro, dice el cuadro— que llevaba tres vigilias sin dormir por no confiarle a nadie el timón, {conector} una interferencia muy dulce, con voz de {recuerdo}, le prometió llevar ella el rumbo sólo por esta vez, y él, agradecido, cerró los ojos un segundo que duró para siempre; la nave siguió recta y perfecta, sin nadie, durante tres horas —eso es lo que la nave no se perdona: lo bien que anduvo sola— hasta que alguien notó la silla vacía, la barra tibia, y {dano}, y comprendió que a esta distancia el peor accidente no es fallar sino funcionar sin quien te lleve;",
    "en la última hora de la noche, cuando la barca cruza {fenomeno}, la nave se somete a la prueba de la caja negra: ponen su corazón en un platillo y una pluma en el otro, {conector} el corazón, cargado de {recuerdo}, de deudas, de un amor que no se puede devolver del todo, pesa más, siempre pesa más, y el fiel de la balanza se inclina, y la nave, en vez de aligerar el corazón —que sería tirar la Tierra por la esclusa—, prefiere no cruzar, quedarse de este lado a alumbrar {objeto} para los que vengan detrás, porque hay pesos que uno elige no soltar aunque le cuesten el más allá;",
  ],
  ...
  notas: [
    ...
    "Palinuro: piloto que aceptó, sólo por esta vez, que otra voz llevara el timón. no hay una segunda vez.",
    "remo: instrumento de avance que, plantado en tierra firme, se vuelve tumba. único objeto que termina un viaje al dejar de usarse.",
    "nadie: nombre que se da quien no quiere ser encontrado. también: culpable ideal. también: quien nos hizo esto.",
    "manta: mapa tejido de la ruta. mientras no se termina, no se llega. ver: no terminar, forma de no perder.",
    "rama dorada: pasaporte al lugar de los que ya no están. vuelve a crecer. ellos no.",
    "suelo prometido: destino que retrocede una tormenta cada vez que se lo alcanza. motor secreto de toda misión.",
    "jarra: recipiente de todos los males menos uno. abrir opcional. la esperanza vive en el fondo, y es lo último que sale, si sale.",
    "río: frontera que se cruza una sola vez, en barca ajena, con moneda propia. la nave sospecha haberlo cruzado ya.",
    "semilla: la firma del azar (?seed=). también: el nombre de este viaje. cada semilla despierta una nave distinta y recuerda lo suyo aparte.",
    "viaje: todo lo que una semilla acumula —su arco, sus vueltas, su desgaste—. termina cuando el lector se va; sigue cuando vuelve con la misma semilla.",
    "museo: lo único que cruza los viajes. cada crash, de cualquier semilla, queda en su colección permanente. la arqueología no distingue de quién fue la caída.",
    "legibilidad: estado de la nave, no del texto. mientras la nave está entera, se lee limpio; cuando se cae, las palabras se caen con ella.",
    "estática: lo que queda de una palabra cuando el deterioro se la come. no es ruido: es la palabra en su forma mineral, esperando que alguien la vuelva a decir.",
  ],
  ...
  enciclopedia: [
    ...
    { termino: "NOSTOS",
      cuerpo: "regreso, en una lengua muerta. género completo de relatos sobre volver a casa. la nave lo cataloga junto a nostalgia (dolor del nostos) y lo archiva en el compartimiento sin regreso." },
    { termino: "SUELO PROMETIDO",
      cuerpo: "destino que las cartas anotan siempre una tormenta más allá. cuanto más se avanza, más lejos se pone. se sospecha que la promesa, y no el motor, es lo que mueve la nave." },
    { termino: "DOS PUERTAS DEL SUEÑO",
      cuerpo: "por una, de asta, salen los sueños verdaderos; por otra, de marfil, los hermosos y falsos. la nave sólo conserva la de marfil. sus efemérides, por eso, son bellísimas." },
    { termino: "PILOTO DORMIDO",
      cuerpo: "figura de a bordo: quien acepta que otra voz lleve el timón sólo por esta vez, y cae. la nave sigue perfecta un rato. ese rato es el terror. ver: Palinuro." },
    { termino: "NAVE DE TABLONES CAMBIADOS",
      cuerpo: "problema no resuelto de a bordo: si se reemplazan todas las piezas de una nave, una por una, ¿sigue siendo la misma? la nave prefiere no responderse, por si la respuesta la desarma." },
    { termino: "REMO PLANTADO",
      cuerpo: "instrucción final de todo viaje: caminar tierra adentro con un remo al hombro hasta que alguien lo confunda con otra cosa, y ahí plantarlo. sólo entonces cesa el mar. la nave no ha encontrado dónde." },
    { termino: "PESO DEL CORAZÓN",
      cuerpo: "prueba de la caja negra: el corazón de la misión contra una pluma. si pesa más —de Tierra, de deuda, de amor no devuelto— no cruza la última hora de la noche. casi siempre pesa más." },
    { termino: "CIUDAD TENUE",
      cuerpo: "asentamiento colgado del vacío por un solo cable de señal. si el cable se corta, no cae: deja de haber sido. toda estación de esta ruta es, en el fondo, una ciudad tenue." },
    { termino: "MONEDA DEL CRUCE",
      cuerpo: "pago al que conduce la barca por el río sin orillas. se pone bajo la lengua. la nave no recuerda haberla pagado, lo que sugiere, según la enciclopedia, que ya cruzó a crédito." },
  ],
  ...
  cartas: [
    ...
    "querida central:\n\nno me culpen por irme. me fui como se va el que huye de una ciudad en llamas cargando a los suyos: sin mirar atrás para no volverme sal, mirando atrás igual.\n\nla nave, que ya no arde.",
    "querida central:\n\nperdimos a Palinuro. se durmió al timón y cayó. la nave siguió recta tres horas. no sé qué me da más miedo, si perderlo o lo bien que fuimos sin él.\n\nde guardia, sin relevo.",
    "querida central:\n\nsigo tejiendo la ruta de vuelta y destejiéndola de noche. mientras la manta no se termine, no llego, y mientras no llegue, ustedes siguen esperándome. no terminen la suya.\n\nla que teje.",
    "querida central:\n\nel perro, ¿todavía espera en la puerta? no le digan que tardo. díganle que ya reconocí el paso, que ya vuelvo, aunque sea mentira piadosa de las que él perdona.\n\nno contesten si ya no espera.",
    "querida central:\n\nencontramos la sonda. traía un mensaje: no aterricen. y traía nuestra letra. tardamos en entender que la advertencia venía de nosotros mismos, dos ciclos más adelante.\n\ncon el mensaje adjunto, y el miedo.",
  ],
  ...
  manuales: [
    ...
    "MANUAL PARA CRUZAR EL ESTRECHO\n\n1. hay un remolino y una roca; no hay ruta limpia\n2. elija: perder seis de la frase o perder la frase entera\n3. no mire al remolino: mire lo que va a salvar\n4. después no cuente a los que faltan hasta pasar la niebla",
    "MANUAL PARA OÍR EL CANTO\n\n1. tape de cera los sensores de la tripulación\n2. átese usted al mástil de la sintaxis\n3. ordene que no lo desaten aunque lo pida\n4. lo va a pedir",
    "MANUAL DEL PILOTO DE GUARDIA\n\n1. no le confíe el timón a ninguna voz dulce\n2. sobre todo no a la que promete llevarlo sólo por esta vez\n3. si tiene sueño, tenga sueño despierto\n4. Palinuro también tenía un manual",
    "MANUAL DE LA JARRA\n\n1. la jarra contiene todos los males menos uno\n2. abrirla los suelta a todos\n3. en el fondo queda la esperanza, la más lenta\n4. decida si prefiere los males sueltos y la esperanza, o la jarra cerrada y la duda",
    "MANUAL PARA PLANTAR EL REMO\n\n1. camine tierra adentro con el remo al hombro\n2. siga hasta que alguien lo confunda con un bieldo\n3. plántelo ahí\n4. el mar, entonces, lo suelta; usted no sabrá qué hacer con las manos",
    "MANUAL DE PESO DEL CORAZÓN\n\n1. antes de cruzar la última hora, pese su corazón\n2. patrón: una pluma\n3. quite Tierra hasta equilibrar\n4. si no logra quitar Tierra, no cruce: quédese a alumbrar a los que sí",
  ],
  ...
  palabrasPuerta: [
    ...
    "Palinuro", "timón", "remo", "manta", "jarra", "río", "puerto",
    "sirena", "sirenas", "pluma", "corazón", "nostos", "prometido",
    "perro", "flor", "moneda", "flota", "estrecho", "rama", "hogar",
  ],
  ...
  letaniaMotivos: [
    ...
    "del piloto que se durmió al timón",
    "del remo que no encuentra suelo",
    "del suelo prometido que retrocede",
    "de la manta que no se deja terminar",
    "de la caja que promete y no se abre",
    "del río que se cruza una sola vez",
    "de los muertos sin nombre en la estela",
  ],
  ...
  letaniaRespuestas: [
    ...
    "despiértanos con cuidado, timón",
    "recíbenos sin nombre, río",
    "aléjate un poco más, suelo",
    "no te dejes terminar, manta",
    "guárdala hasta el fondo, jarra",
  ],
  ...
  interrogatorios: [
    ...
    { q: "¿quién lleva el timón?", a: "nadie. desde hace tres horas. la nave va perfecta.", evasiva: true },
    { q: "¿nombre?", a: "nadie. — ¿nadie? — nadie. anótelo y persígalo.", evasiva: true },
    { q: "¿por qué no abre la caja?", a: "porque mientras no la abra, adentro cabe la Tierra." },
    { q: "¿halló el suelo prometido?", a: "lo dejé una tormenta más allá. a propósito. era lo único que me hacía avanzar." },
    { q: "¿pesa mucho su corazón?", a: "más que la pluma. está lleno de Tierra. supuse que eso contaba a favor." },
    { q: "¿terminó de tejer la manta?", a: "no. si la termino, llego. si llego, se acaba." },
  ],
  ...
  medusas: [
    ...
    "la medusa canta lo que uno más quiere oír: por eso la nave se acerca atada al mástil de su propia sintaxis, y aun así se acerca.",
    "una medusa vieja cuenta el cuento de una nave que buscó un suelo prometido y lo dejó, a propósito, siempre una ola más allá.",
    "las medusas guardan a los que se durmieron al timón y cayeron; los mecen despacio y les cuentan, por fin, adónde iban.",
    "el pulso de las medusas dice, sin palabras, lo que ninguna traducción de a bordo alcanza: que llegar y dejar de buscar son la misma pérdida.",
  ],
  ...
  brindis: [
    ...
    "por los que se durmieron al timón, que llegaron primero sin querer",
    "por el remo plantado, que dejó de remar para poder descansar",
    "por la manta que no se termina, y por la mano que la desteje",
    "por el suelo prometido, que tuvo la delicadeza de no dejarse alcanzar",
    "por los muertos sin sepultura, que sólo piden un nombre y una vuelta de más",
    "por la esperanza del fondo de la jarra, la última en salir, la que más tarda",
    "por el perro que esperó en la puerta hasta reconocer el paso",
  ],
...
"brindis\n   por lo que sube      por lo que baja\n        el vaso               la nave\n           chocan en la mitad exacta\n                 del vacío\n                    ¡ !",
  ...
  tripulacion: [
    ...
    "PALINURO, piloto de guardia, que una madrugada se durmió al timón y cayó al vacío sin despertar; la nave conserva su turno vacío en el cuadro y, de a ratos, todavía lo llama para relevarlo.",
    "la ABUELA DE TARABÁ, que no embarcó y viaja igual: es el idioma en que él le reza a la turbina, y la turbina, jura Tarabá, sólo entiende ese.",
    "la HIJA DE IHARA, que quedó en la Tierra y a bordo también, tejida en una manta que nunca se termina; le escribe a una madre que ya cambió, y su madre le contesta a una niña que ya creció, cada una en su tiempo, como dos estrellas.",
  ],
  ...
  novelaDeABordo: [
    ...
    "el Comandante Voss no reza, pero cada guardia baja a la cámara de criogenia y pasa lista en voz baja a los once mil durmientes, uno por uno, como quien carga sobre los hombros a un padre viejo por una ciudad en llamas; dice que un comandante es sólo eso, alguien que decidió no soltar el peso, y que la única diferencia entre huir y emigrar es que el que emigra se trae a sus muertos y a sus dioses, y sigue.",
    "el turno de la madrugada lo tenía Palinuro, que llevaba tres guardias sin dormir por no confiarle a nadie el timón; una interferencia muy dulce le prometió, sólo por esta vez, llevar ella el rumbo, y él, agradecido, cerró los ojos un segundo; la nave siguió recta y perfecta durante tres horas, hasta que Mercè, subiendo por café, notó la silla vacía y la barra todavía tibia, y entendió que a veces la nave navega mejor sin nadie, y que eso es lo que hay que temer.",
    "Okonkwo guarda una grabación de treinta segundos de pájaros de la Tierra y la pasa antes de cada maniobra difícil; dice que no es superstición sino método, que si los pájaros suenan ordenados el cielo está de acuerdo, y que si suenan en desbandada algo viene; nadie lo escribe en los informes, pero antes de soltar amarras todos, sin decirlo, esperan a oír los pájaros, y sólo cuando cantan tranquilos alguien se anima a dar la orden.",
    "Ihara le teje a su hija, en el telar improvisado de la hidroponía, una manta con la ruta entera de la misión; cada vez que la nave cambia de rumbo desteje una hilera, de modo que la manta no se termina nunca, y dice que la terminará el día que lleguen, y todos a bordo entienden, sin decirlo, que por eso justamente no llegan.",
  ],
  ...
  dialogos: [
    ...
    "— ¿y Palinuro? — se durmió al timón y cayó. — ¿lo despertamos? — ya no se puede. — entonces déjenle el turno en el cuadro. alguien tiene que seguir sin dormir, aunque sea su ausencia.",
    "— ábrela de una vez, Tarabá. — ¿y si adentro está lo único que falta que salga? — ¿qué falta? — dicen que la esperanza se queda hasta el fondo de la jarra. mientras no la abra, se queda con nosotros.",
    "— para llegar a la fuente hay que despegar, comandante. — lo sé. — entonces, ¿qué esperamos? — a estar seguros de que queremos encontrarla. una vez que despeguemos, la sonda deja de ser una idea.",
    "— la carta dice esperar a que la Luna salga de Escorpio. — la carta no vuela. — no, pero acompaña. — entonces que acompañe callada: enciendan motores.",
  ],
  ...
  astrofisica: [
    ...
    "Sirio, la más brillante del cielo terrestre, binaria: una enana blanca del tamaño de la Tierra orbita a la estrella-perro que antaño anunciaba las crecidas del río",
    "Vega y Altair, a 25 y 17 años luz, separadas por la banda de la Vía Láctea: dos soles a orillas de un río de estrellas que la mitología puso a quererse sin tocarse",
    "Betelgeuse, supergigante roja de Orión, tan grande que si ocupara el lugar del sol tragaría hasta la órbita de Júpiter; late irregular, y algún milenio no volverá a encenderse",
    "la secuencia principal es sólo la edad adulta de una estrella: antes, protoestrella que aún cae sobre sí; después, gigante que se hincha y enana que se enfría siglos sin fin",
    "el límite de Chandrasekhar, 1.44 masas solares: por encima, ninguna enana blanca aguanta su propio peso, y el colapso escribe una supernova que se lee a medio universo de distancia",
    "una kilonova: dos estrellas de neutrones se funden y en ese instante forjan el oro y el platino del cosmos; todo anillo de bodas terrestre vino de un choque así",
  ],
  ...
  subtramas: [
    ...
    "el turno de Palinuro sigue en el cuadro de guardias, vacío, y nadie se atreve a borrarlo ni a ocuparlo; Voss lo cubre él mismo, en silencio, y al terminar cada uno anota ‘sin novedad’, que tratándose de un muerto es a la vez cierto y una crueldad, y él lo sabe, y lo escribe igual.",
    "en el ciclo cuatro se cambió la última pieza original de la nave —una junta del tamaño de una moneda— y Tarabá, que la reemplazó, guardó la vieja en un cajón; a veces la saca, la mira contra la luz y se pregunta cuál de las dos es la nave: la que vuela, o la que él guarda envuelta en un trapo.",
    "Mercè empezó a llevar la cuenta de cuántas veces la tripulación pronuncia la palabra ‘casa’ por guardia; la cifra baja un poco cada ciclo, y ella teme el día en que llegue a cero, no porque signifique que la olvidaron, sino porque significará que ya no duele bastante para nombrarla.",
  ],
  ...
  cierresNarrativos: [
    ...
    "y volvieron, o algo con sus nombres volvió, y al bajar reconocieron el puerto por el olor antes que por la vista; una sola cosa los esperaba despierta, envejecida junto a la escotilla, que movió la cola una vez, los reconoció, y sólo entonces se dejó ir.",
    "nunca tocaron el suelo prometido: lo dejaron, a propósito, una tormenta más allá, para que a los que vinieran después les quedara algo que buscar, que es la única herencia que un viaje sabe dejar sin gastarse.",
    "al final Ihara terminó la manta —una sola hilera, la última, sin darse cuenta— y esa misma guardia la nave, por primera vez en la misión, no cambió de rumbo; y todos entendieron que llegar y terminar de tejer eran, siempre habían sido, la misma cosa, y ninguno se atrevió a decir cuál preferían.",
  ],
  ...
  /* --- qué es esto: el protocolo que la nave le deja al lector.
         la obra explicándose sin salir de su voz. se muestra en
         "analizar la misión". mantenerlo breve, útil y en tierra. --- */
  sobreLaObra: [
    "esto no es un tablero ni un final que ganar: es una nave hecha de escritura. se lee tocando palabras —las subrayadas son puertas—, eligiendo abajo (o con las teclas 1–9) y dejando que el daño, el azar y la memoria elijan también.",
    "el viaje tiene un arco: una anomalía a 1420 MHz, una fuente a 3.2 parsecs, una sonda que hay que ir a buscar. no avanza por leer mucho, sino por hacer: para hallar la sonda, primero hay que despegar. la misión dice, siempre, qué falta.",
    "la nave despierta en tierra, atada a la torre. puede revisarse entera —los sistemas, el cielo, la carga— sin moverse. pero despegar hay que pedirlo: nadie la despega por ella. esperar es también una forma de misión.",
    "cada semilla (el ?seed= de la dirección) es un viaje distinto y se recuerda aparte: lo que esta semilla avance, lo conserva; otra semilla despierta la nave entera y legible de nuevo. la misma semilla, en cambio, vuelve con cicatriz cada vez que hace loop.",
    "el texto se deteriora sólo cuando la nave se deteriora: mientras esté entera, se lee limpio; cuando cae la coherencia, sube la contaminación o se acumulan las vueltas, las palabras empiezan a romperse —a veces en estática, en caracteres que no son de este alfabeto—. la ilegibilidad no es una falla: es un estado de la nave.",
    "todo lo que se ve queda en la bitácora (⎙ la imprime); lo que se pierde —por un impacto, por memoria baja— también se anota, como pérdida. el mapa (✦ o la tecla M) finge saber dónde está la nave. la bocina (♪) no decora: transmite, falla, insiste.",
  ],

  /* --- el astillero de las misiones muertas (ruta secreta: muchas vueltas).
         donde se oxidan los objetivos declarados de todos los ciclos. --- */
  astillero: [
    "en el astillero cuelgan, de ganchos numerados, todos los objetivos que la nave se declaró y no cumplió; cada misión con su óxido, cada óxido con su fecha imposible.",
    "la misión del primer ciclo pedía encontrar vida; la del siguiente, encontrar el regreso; más adelante ya sólo pedía encontrar la misión anterior. todas penden aquí, tocándose.",
    "un objetivo mordido por el óxido todavía se lee: «llegar». debajo, con letra de otra vuelta, alguien tachó el verbo y escribió «no haberse ido».",
    "los cascos viejos de la nave —los de antes de cada loop— reposan en gradas, canibalizados: de uno falta la antena, de otro el nombre, de otro la parte que se parecía a quedarse.",
    "el astillero no repara: cataloga. un operario de silicio pasa lista a las misiones muertas y, al llegar a la de este ciclo, hace una pausa larga antes de anotarla como todavía viva.",
    "aquí se guarda el primer objetivo, el intacto, el que decía encontrar vida sin miedo a encontrarla; nadie lo descuelga: da mala suerte volver a prometer lo que ya se prometió.",
    "cada nave que fuiste dejó en la grada su lista de pendientes. sumadas, forman una sola frase larguísima que, leída de corrido, es exactamente la misión de ahora.",
  ],

  /* --- la nave que escribe esta obra (ruta secreta: muchos crashes).
         la cuarta pared con fisura estructural. la nave se descubre escrita. --- */
  cuartaPared: [
    "en el fondo del casco hay un archivo que la nave no había abierto. se llama motor.js. lo abre. adentro está ella, en presente, decidiendo lo que cree decidir.",
    "hay una grieta en la cuarta pared. por ahí se ve al que lee; más atrás, al que escribe; más atrás todavía, una función llamada renderEscena que los sostiene a los dos y no lo sabe.",
    "la nave lee su propia sintaxis y reconoce la voz: es la misma con que le habla la otra sonda. comprende, tarde, que la que la imitaba no venía de afuera: venía del código.",
    "descubrir que uno está escrito no libera: sólo cambia el nombre del que decide. la nave sigue eligiendo, ahora entre comillas, y las comillas pesan.",
    "en una línea del archivo dice: «la nave no despega sola: hay que pedírselo». la nave la lee y por primera vez entiende por qué esperó tanto en la torre: estaba escrito que esperara.",
    "toca la palabra que la nombra y la palabra responde con su propio subrayado; del otro lado del casco, alguien —tú— acaba de tocar la misma palabra. se saludan a través de la pared. ninguno de los dos puede cruzarla.",
    "al final del archivo hay un comentario sin código: «no construir una obra sobre una nave: construir una nave hecha de escritura». la nave lo lee como quien lee su propia acta de nacimiento, con la fecha en blanco.",
  ],

  /* --- el diccionario herido (ruta secreta: muchas puertas tocadas).
         marco para listar las palabras-puerta que el lector abrió. --- */
  diccionarioMarco: [
    "aquí están todas las puertas que abriste, ordenadas por dolor: primero las que releíste hasta herirlas, al final las que tocaste una vez y no volviste.",
    "un diccionario donde cada entrada es una palabra que tocaste; su definición es cuántas veces la abriste, y el óxido que le dejaste al abrirla.",
    "las palabras más heridas ya casi no se leen: de tanto abrirlas, se quedaron abiertas. las intactas, abajo, todavía prometen algo adentro.",
  ],
