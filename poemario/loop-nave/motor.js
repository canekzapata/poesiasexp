...
function puertaAleatoria(palabra) {
  ...
  if (r < 0.38) {
    ...
    spec = { acc: "insertar", arg: azar(["eco", "archivo", "manual", "senal", "poemaConcreto", "error404", "enciclopedia", "letania", "interrogatorio", "xeno", "cientifico", "telemetria", "espectro", "exobiologia", "autopsia", "cartaAstro"]) };
  } else if (r < 0.88) {
...
const NAVEGABLES = [
  ...
  "campoDePolvo", "muestraEnCuarentena",
...
const ESCENAS = {
  ...
  /* --- 43 · escenas que la memoria desbloquea ------------------------------------------------------------------------- */
  jardin() {
