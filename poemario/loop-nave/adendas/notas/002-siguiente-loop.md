...
> pendiente aún: audio de fondo sembrado, contaminación que se propaga,
> lector fantasma, edición impresa (tecla P), rutas secretas nuevas, y la
> ruta-constelación que relee cada escena como la recuerda la nave; convendría
> también completar `fonts/` (faltan los CRT Ac437, las lineales A/B, el egipcio,
> el anatolio y unifont) para que cada régimen tenga su letra —hoy degradan a
> fuentes de sistema.
