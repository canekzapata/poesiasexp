...
(function (root) {
  ...
  function decide(seed, forceSpecies) {
    ...
    var glyphs = Object.assign({}, rng.pick(Corpus.paletas));
    // Grafía exótica: muy rara vez (≈4%) una cara entera de la pieza deja de
    // ser tipográfica y se vuelve jeroglífica. Es exclusiva justamente porque
    // casi no se selecciona.
    var exoticRng = rng.fork("grafia-exotica-v13");
    var exoticGlyph = null, exoticFontKind = null;
    if (exoticRng.chance(0.11)) {
    ...
    var intrusion = rng.fork("intrusion-v13").chance(0.46);
  ...
  function makeSculpturalSurface(traits, interpretation, rng) {
    ...
    var groundChance = assembly === "ESFERA MONUMENTAL" || assembly === "ONDA ESTACIONARIA" ||
      assembly === "PARABOLOIDE MONUMENTAL" ? 0 : 0.72;
  ...
  function applyIntrusions(surface, traits, rng) {
    ...
    // piezas de miles de glifos. Ahora escala con el tamaño y llega a doce.
    var count = clamp(2 + Math.floor(visibles.length / 150), 2, 12);
