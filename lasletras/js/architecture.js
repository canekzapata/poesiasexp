...
(function (root) {
  ...
  var SCULPTURAL_ASSEMBLIES = [
    ...
    "ONDA ESTACIONARIA", "LAZO ATRAVESADO"
  ];
  ...
  function makeSculpturalSurface(traits, interpretation, rng) {
    ...
    var groundChance = assembly === "ESFERA MONUMENTAL" || assembly === "ONDA ESTACIONARIA" ? 0 : 0.72;
  ...
  function addParabolicAntennaCrown(builder, centerX, width, top, traits, rng) {
    ...
    // del edificio y recibe más anillos para no perder densidad.
    var monumental = rng.chance(0.45);
