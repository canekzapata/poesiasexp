...
(function (root) {
  ...
  var TAU = Math.PI * 2;
  var MORPHOLOGIES = ["ESTRATOS", "COSTILLAS", "PANTALLA", "ANILLO", "PLIEGUE", "TÓTEM", "VÓRTICE", "CELOSÍA", "HIPERBOLOIDE", "ZIGURAT", "ACUEDUCTO", "VOLADIZOS", "MÉNSULAS", "TORRE HELICOIDAL", "CUBOS ENCAJADOS"];
  ...
  var ARCH_STRUCTURES = ["MASA ARQUEADA", "ARCADAS", "TORRE HELICOIDAL", "MÉNSULAS", "BÓVEDAS", "ROTONDA", "CUBOS ENCAJADOS", "COSTILLAS", "LOSAS", "ZIGURATS", "COLUMNAS", "PÓRTICOS", "CELOSÍAS", "PANTALLAS", "CINTAS"];
  ...
  var MORPHOLOGY_WEIGHTS = [
    ...
    { nombre: "COSTILLAS", peso: 16 }, { nombre: "TORRE HELICOIDAL", peso: 16 },
  ...
  var ARCH_STRUCTURE_WEIGHTS = [
    ...
    { nombre: "TORRE HELICOIDAL", peso: 17 }, { nombre: "MÉNSULAS", peso: 15 },
