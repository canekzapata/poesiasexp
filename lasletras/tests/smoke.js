...
assert.strictEqual(first.meta.version, "0.20.0");
...
assert(intrusionPieces > 820 && intrusionPieces < 1000, "cerca de 46% de las piezas deben admitir intrusiones");
...
assert(exoticPieces > 160 && exoticPieces < 290, "la grafía exótica debe seguir siendo minoritaria pero visible (≈11%)");
