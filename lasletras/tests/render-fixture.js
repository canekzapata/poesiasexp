...
function render(seed, output) {
  ...
  var label = piece.geometry.genealogy
    ...
    : piece.geometry.assembly
      ? piece.geometry.assembly + " / " + piece.geometry.modules.join(" + ")
      : piece.geometry.kind;
  var svg = '<?xml version="1.0" encoding="UTF-8"?>\n' +
    ...
    (progress >= 1 ? '<g fill="' + piece.colors.frente + '" text-anchor="end"><text x="946" y="930" font-size="11">ESPACIO ESCULTÓRICO · v' + piece.meta.version.replace(/^v/, "") + '</text>' +
