...
Prueba estadística y determinista:
...
`Especie`, `Forma`, `Alfabeto`, `Color`, `Temperatura`, `Perspectiva`, `Volumen`,
`Estructura`, `Vacío`, `Cubierta`, `Copia carbón` y `Anomalía`. Verse los captura
