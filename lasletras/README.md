...
La cubierta puede ser **NINGUNA**. En la auditoría actual aparece en cerca de
...
| **Interfaz** | cabecera, panel, botones, exportaciones, teclas | sólo la obra + vínculo `GIF ↘` casi invisible |
