(function (global) {
  ...
  function rareEvent() {
    ...
    record("rareza", eventName, "rareza:" + (config.id || "portal") + ":" + eventName);
  ...
  function bindConditions() {
    ...
    document.addEventListener("keydown", function (event) {
      ...
      if (paused && typeof global.__stopTextAutomata === "function") global.__stopTextAutomata();
    });
    global.addEventListener("pagehide", function () {
      timers.forEach(clearTimeout);
      timers = [];
      if (typeof global.__stopAutomata === "function") global.__stopAutomata();
      if (typeof global.__stopTextAutomata === "function") global.__stopTextAutomata();
    }, { once: true });
  }
