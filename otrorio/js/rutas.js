(function (global) {
  ...
  function emptyMemory() {
    return { visited: [], recent: [], visits: {}, durations: {}, residues: [], windows: 0, births: 0, zaps: 0, lastPage: null, lastAt: null };
  }
  ...
  function explorationTarget() {
    ...
    return candidates.reduce(function (best, genome) {
      ...
      var score = (unused ? 140 : 0) - visits * 17 + Math.min(34, distance) * 1.3 + favoriteReturn + rng() * 28;
