(function (global) {
  ...
  function eligible(node) {
    ...
    if (node.closest("script,style,noscript,canvas,svg,iframe,form,button,input,select,textarea,.permanent-routes,.lab-meta,.footnote-bar,.relic-toast,.relic-codex,.relic-sources,[aria-hidden=true]")) return false;
