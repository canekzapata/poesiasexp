...
`       00000100000
    ...
    acontecimientos: {
      ...
      lengua: [
        "Una lengua extranjera comentó el gesto en {page}: {detail}.",
        "El trayecto cambió de idioma sin cambiar de página: {detail}.",
        "La interfaz produjo una voz lateral y la archivó como {detail}."
      ],
      rareza: [
    ...
    poliglotas: {
      inglesTrayecto: [
        ...
        "Your cursor is the only breadcrumb the interface agrees to keep.",
        "UX note: the exit is visible, but visibility is not the same as consent.",
        "UI note: this control has mistaken surprise for feedback.",
        "Journey note: the previous page is still leaking into this one."
      ],
      francesTrabalenguas: [
        ...
        "Le lecteur léger longe les lignes, les lignes longent le lecteur.",
        "Sous ce signe-ci, cinq ciels cessent sans cesse de scintiller."
      ],
      portuguesCorriente: [
        ...
        "(ó viagem-vírus! o verso vaza janelas, varre variáveis.)",
        "(arquivo-arquipélago: cada tag tange outra terra-tela.)"
      ],
      alemanSistema: [
        ...
        "Die Ordnung kam zu spät; der Rand hatte schon begonnen.",
        "Benutzerführung ohne Benutzer, Führung ohne Ziel."
      ]
    },
    griegoAntiguo: {
      variedad: "griego antiguo / Heráclito y corpus épico-lírico de poemario",
      fragmentos: [
        { clave: "rio", grc: "ποταμοῖσι τοῖσιν αὐτοῖσιν ἐμβαίνουσιν ἕτερα καὶ ἕτερα ὕδατα ἐπιρρεῖ.", es: "Para quienes entran en los mismos ríos, fluyen unas y otras aguas.", fuente: "Heráclito, DK B12" },
        { clave: "ruta", grc: "ὁδὸς ἄνω κάτω μία καὶ ὡυτή.", es: "El camino hacia arriba y hacia abajo es uno y el mismo.", fuente: "Heráclito, DK B60" },
        { clave: "oculto", grc: "φύσις κρύπτεσθαι φιλεῖ.", es: "La naturaleza ama ocultarse.", fuente: "Heráclito, DK B123" },
        { clave: "destino", grc: "ἦθος ἀνθρώπῳ δαίμων.", es: "El carácter es para el ser humano su destino.", fuente: "Heráclito, DK B119" },
        { clave: "viaje", grc: "ἄνδρα μοι ἔννεπε, μοῦσα, πολύτροπον, ὃς μάλα πολλὰ πλάγχθη.", es: "Háblame, Musa, del hombre de muchos caminos, que anduvo errante largamente.", fuente: "poemario/homerody.txt · apertura · glosa editorial" },
        { clave: "retorno", grc: "σοὶ δ’ ὁδὸς οὐκέτι δηρὸν ἀπέσσεται ἣν σὺ μενοινᾷς·", es: "El camino que deseas ya no permanecerá mucho tiempo lejano.", fuente: "poemario/homerody.txt · verso 729 aprox. · glosa editorial" },
        { clave: "rio", grc: "ὡς δ’ ὅτε χείμαρροι ποταμοὶ κατ’ ὄρεσφι ῥέοντες ἐς μισγάγκειαν συμβάλλετον ὄβριμον ὕδωρ", es: "Como torrentes que bajan de los montes y juntan su agua violenta en una confluencia.", fuente: "poemario/homeriliad.txt · versos 2401–2402 aprox. · glosa editorial" },
        { clave: "huella", grc: "ἠερίῳ ξένον ἴχνος ἐρετμώσαντες ἀήτῃ,", es: "Remando una huella extranjera por el viento aéreo.", fuente: "poemario/nonnus.txt · verso 146 aprox. · glosa editorial" },
        { clave: "rutas", grc: "ὁδῶν ὁδοὶ περαίτεραι, μία δ’ οὐχ ἅπαντας ἄμμε θρέψει μελέτα·", es: "Hay caminos más allá de los caminos; una sola práctica no nos alimentará a todos.", fuente: "poemario/pindar.txt · versos 740–743 aprox. · glosa editorial" },
        { clave: "escritura", grc: "ἐπίκουρον εὑρὼν ὁδὸν λόγων", es: "Encontrando un camino aliado de palabras.", fuente: "poemario/pindar.txt · verso 115 aprox. · glosa editorial" }
      ],
      palabras: [
        { grc: "ὁδός", es: "camino" }, { grc: "μνήμη", es: "memoria" }, { grc: "λείψανον", es: "resto / reliquia" },
        { grc: "ποταμός", es: "río" }, { grc: "ξένος", es: "huésped / extranjero" }, { grc: "χρόνος", es: "tiempo" },
        { grc: "φῶς", es: "luz" }, { grc: "σκιά", es: "sombra" }, { grc: "γράμμα", es: "letra / inscripción" },
        { grc: "ἴχνος", es: "huella" }, { grc: "λαβύρινθος", es: "laberinto" }
      ],
      fuentes: [
        { titulo: "The Fragments of the Work of Heraclitus of Ephesus", url: "https://archive.org/details/fragmentsofworko00hera" },
        { titulo: "Heraclitus: The River Fragments / Binghamton University", url: "https://orb.binghamton.edu/sagp/253/" }
      ]
    },
    nahuatl: {
      ...
      fragmentos: [
        { clave: "tierra", nah: "An nochipa tlalticpac: zan achica ye nican.", es: "No para siempre en la tierra: sólo un poco aquí.", fuente: "Cantares mexicanos" },
        { clave: "ruta", nah: "Campa nel tiazque?", es: "¿Hacia dónde iremos, en verdad?", fuente: "Cantares mexicanos" },
        { clave: "verdad", nah: "Azo tla nel o tic itohua nican?", es: "¿Acaso decimos aquí algo verdadero?", fuente: "Cantares mexicanos" },
        { clave: "sueño", nah: "Zan tontemiqui, in zan toncochitlehuaco.", es: "Sólo soñamos, sólo despertamos del sueño.", fuente: "Cantares mexicanos" },
        { clave: "retorno", nah: "Cuix oc ceppa ye tonemiquiuh?", es: "¿Acaso volveremos a vivir otra vez?", fuente: "Cantares mexicanos" },
        { clave: "escritura", nah: "In tlilli, in tlapalli.", es: "La tinta negra, el color rojo: escritura y saber.", fuente: "tradición nahua" },
        { clave: "canto", nah: "In xochitl, in cuicatl.", es: "La flor, el canto: palabra florida.", fuente: "tradición nahua" },
        { clave: "lugar", nah: "In atl, in tepetl.", es: "El agua, el cerro: el lugar como cuerpo doble.", fuente: "tradición nahua" }
      ],
      parrafos: [
        { clave: "ruta", nah: "Campa nel tiazque? Ca zan titlacatico. Ca ompa huel tochan, in canin Ximoayan, in oncapa in Yolihuayan aic tlamian.", es: "¿Hacia dónde iremos, en verdad? Sólo hemos nacido; allá está nuestra casa, en Ximoayan, donde el vivir no termina.", fuente: "Cantares mexicanos" },
        { clave: "tierra", nah: "An nochipa tlalticpac: zan achica ye nican. Tel ca chalchihuitl no xamani, no teocuitlatl in tlapani, no quetzalli poztequi.", es: "No para siempre en la tierra: sólo un poco aquí. El jade se quiebra, el oro se rompe, la pluma de quetzal se desgarra.", fuente: "Cantares mexicanos" },
        { clave: "sueño", nah: "Azo tla nel o tic itohua nican, Ipalnemohuani? Zan tontemiqui, in zan toncochitlehuaco; ayac nelli in quilhuia nican.", es: "¿Acaso decimos aquí algo verdadero? Sólo soñamos, sólo despertamos; nadie dice aquí una verdad definitiva.", fuente: "Cantares mexicanos" },
        { clave: "retorno", nah: "Cuix oc ceppa ye tonemiquiuh? In yuh quimati moyol: zan cen tinemico.", es: "¿Volveremos a vivir otra vez? Que lo sepa tu corazón: sólo una vez venimos a vivir.", fuente: "Cantares mexicanos" }
      ],
      fuentes: [
