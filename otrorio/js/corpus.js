...
`       00000100000
    ...
    acontecimientos: {
      ...
      injerto: [
        "La página {page} recibió un órgano ajeno: {detail}.",
        "Una parte de otra dirección se recompuso dentro de {page}: {detail}.",
        "El recorrido del lector mezcló dos páginas y dejó visible {detail}."
      ],
      espera: [
