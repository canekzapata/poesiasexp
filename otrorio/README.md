...
usa la semilla `otra-agua-2026`: 34 páginas, 19 topologías y 4 nodos que el mapa
no revela.
...
Cada página nace además con entre cinco y nueve botones-poema. `+5` siembra
cinco controles nuevos; los demás pueden aumentar el ruido, cultivar ASCII,
soltar texto, cambiar la escala o abrir una gráfica. El límite evita que el
navegador quede sepultado, pero no elimina la sensación de proliferación.
