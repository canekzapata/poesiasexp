...
| C · D · E · F · J | | pendientes (ver `LOOP_STATE.md`) |
...
ninguna-prueba-viaja-sola/
  ...
  js/regimes/           packing · codes · lattice · convex
...
Comprueban consola limpia en los 25 documentos, ausencia de callejones sin
salida, determinismo por semilla, pérdida de bits, `pushState`/Atrás, aparición
de la copia, detección de triángulos monocromáticos, composición del acta con
datos reales, móvil y `prefers-reduced-motion`.
