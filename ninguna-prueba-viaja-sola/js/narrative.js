...
(function (N) {
  ...
  const INVARIANTES = {
    ...
    'el-atajo-se-pago':                 ['E', 'un atajo del circuito se pagó en otra medida'],
    'el-circuito-fue-simplificado-tres-veces': ['E', 'el circuito fue simplificado hasta cambiar de forma'],
    'la-espera-simplifico-el-circuito': ['E', 'la inactividad simplificó el circuito sin permiso'],

    /* S · el expediente espectral. no son obligatorios para terminar la
       obra: añaden una lectura, no una condición. */
    'un-parcial-fue-sostenido':         ['S', 'un parcial cruzó el umbral audible y ya no lo desanda'],
    'una-accion-viajo-a-otra-pagina':   ['S', 'algo que se hizo en una página volvió en otra'],
    'la-copia-termino-un-gesto':        ['S', 'la copia completó una morfología que quedó interrumpida'],
    'el-espectro-recordo-mal':          ['S', 'una huella volvió tantas veces que dejó de poder asegurarse'],
    'la-poda-detuvo-un-regreso':        ['S', 'la poda cerró la última vía por la que algo podía volver'],

    'conexion-eliminada':               ['J', 'se quitó una relación que la prueba necesitaba'],
    'la-demostracion-fallo':            ['J', 'la ley quedó refutada con un contraejemplo construido a mano'],
  ...
  function movimiento() {
    ...
    if (h['la-demostracion-fallo']) return 4;   // el fracaso es el movimiento V
