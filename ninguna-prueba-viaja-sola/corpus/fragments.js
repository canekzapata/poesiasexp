...
(function (N) {
  ...
  const TESTIGO = [
    ...
    'No existe un circuito pequeño para este mensaje. La ruta directa es, medida en nodos, la más larga.',
    'Toda simplificación funciona. El ahorro no se descuenta del circuito: se descuenta del expediente.'
  ];
