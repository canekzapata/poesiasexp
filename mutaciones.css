...
Este documento diseña una posible capa futura de Tone.js. No forma parte del
runtime actual y no debe activarse hasta que la navegación visual y textual
...
- botón de silencio permanente;
- el audio nunca desbloquea rutas necesarias.

La implementación debe ocurrir como módulo opcional `js/sonido.js`, después de
`acontecimientos.js`, sin contaminar el generador ni convertir la pieza en un
