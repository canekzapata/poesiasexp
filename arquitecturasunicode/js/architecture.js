...
(function (root) {
  ...
  var TAU = Math.PI * 2;
  var MORPHOLOGIES = ["ESTRATOS", "COSTILLAS", "PANTALLA", "ANILLO", "PLIEGUE", "TÓTEM"];
  ...
  var ARCH_STRUCTURES = ["LOSAS", "PÓRTICOS", "COSTILLAS", "BÓVEDAS", "PANTALLAS", "COLUMNAS", "CINTAS"];
  ...
  function addMorphology(builder, morphology, spec, rng) {
    ...
    else addTotem(builder, spec, rng);
  }
