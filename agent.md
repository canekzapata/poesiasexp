...
Lee estas instrucciones completamente.

Busca y lee los AGENTS.md adicionales entre la raíz y la carpeta activa.

Si la tarea afecta diseño, interfaz, navegación, animación, visuales generativos o experiencia web, lee completamente WEB_DESIGN_PROTOCOL.md.

Si la tarea afecta audio o música algorítmica, lee el protocolo musical correspondiente.

Lee los archivos relevantes de la pieza antes de proponer cambios.

Conserva las modificaciones existentes del usuario.

Una instrucción explícita del usuario tiene prioridad sobre estos documentos.
