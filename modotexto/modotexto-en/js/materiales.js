...
(function (root) {
  ...
  var PALETAS = [
    {
      clave: "riso", nombre: "colored riso", peso: 3,
    ...
    {
      clave: "archivo", nombre: "archive paper", peso: 3,
    ...
    {
      clave: "carbon", nombre: "carbon copy", peso: 2,
    ...
    {
      clave: "plano", nombre: "blueprint", peso: 3,
    ...
    {
      clave: "cartulina", nombre: "acid cardstock", peso: 2,
    ...
    {
      clave: "noche", nombre: "terminal night", peso: 3,
    ...
    {
      clave: "ambar", nombre: "phosphor amber", peso: 2,
    ...
    {
      clave: "verde", nombre: "green monochrome", peso: 1,
  ...
  var PALETA_CONTRASTE = {
    clave: "contraste", nombre: "high contrast", peso: 0,
  ...
  var MATERIALES = [
    {
      clave: "cal", nombre: "limewash", tinta: 7, junta: "│",
      rampa: ["█", "▓", "▒", "░", "·", " "],
      cara: ["▓", "▒", "░", "░", "·", " "],
      grano: ".,:;'",
    ...
    {
      clave: "ladrillo", nombre: "brick", tinta: 4, junta: "═",
      rampa: ["█", "▓", "▚", "▒", "░", " "],
      cara: ["▓", "▚", "▒", "░", "·", " "],
      grano: "▄▀▌▐",
    ...
    {
      clave: "sextante", nombre: "sextant", tinta: 3, junta: "╬",
      rampa: ["█", "🬲", "🬕", "🬊", "🬀", " "],
      cara: ["🬭", "🬧", "🬔", "🬅", "·", " "],
      grano: "🬂🬋🬎🬹",
    ...
    {
      clave: "esquirla", nombre: "shard", tinta: 5, junta: "╳",
      rampa: ["█", "▛", "╳", "╲", "╱", " "],
      cara: ["▟", "▜", "╳", "╱", "·", " "],
      grano: "╱╲╳",
    ...
    {
      clave: "hollin", nombre: "soot", tinta: 8, junta: "┼",
      rampa: ["█", "▓", "▒", "░", "∙", " "],
      cara: ["▓", "▒", "░", "∙", "·", " "],
      grano: "∙·°",
    ...
    {
      clave: "papel", nombre: "paper", tinta: 6, junta: "┊",
      rampa: ["▓", "▒", "░", ":", ".", " "],
      cara: ["▒", "░", ";", ".", "·", " "],
      grano: ".,:;",
    ...
    {
      clave: "hueso", nombre: "bone", tinta: 15, junta: "╪",
      rampa: ["█", "▒", "▖", "°", "¨", " "],
      cara: ["▓", "▗", "¤", "´", "·", " "],
      grano: "°¨´¤",
    ...
    {
      clave: "cuadrante", nombre: "quadrant", tinta: 2, junta: "╫",
      rampa: ["█", "▙", "▚", "▖", "·", " "],
      cara: ["█", "▟", "▞", "▝", "·", " "],
      grano: "▖▗▘▝",
