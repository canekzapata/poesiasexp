...
(function (root) {
  ...
  V.componer = function (mundo, cx, cy, causa) {
    ...
    lineas.push("region " + cx + "," + cy + " r=" + this.rng.int(3, 6) + "  level " + mundo.nivel + "  cause " + (causa || "?"));
    lineas.push("");
    ...
    lineas.push("");
    lineas.push("seed " + mundo.semilla + "  pos " + mundo.pos.x + "," + mundo.pos.y +
                "  ang " + Math.round(mundo.dirAng * 180 / Math.PI) + "°");
    lineas.push("the region will not be the same again for this seed");
    return lineas;
  };
