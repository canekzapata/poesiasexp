...
- la `§` de la esquina superior derecha despliega los rasgos;
...
rejilla y semilla. La anomalía no aparece ahí.
...
`../otrorio/js/automatas.js`. Por eso la pieza vive dentro del repositorio y no
como carpeta suelta.
...
y que el léxico se agote y empiece a mezclarse.
