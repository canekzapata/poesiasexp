...
(function (root) {
  ...
  var NOMBRE_ORIGEN = [
    "vacio", "muro", "automata", "lexico", "ruido",
    "interfaz", "piso", "cielo", "cuerpo", "volcado", "inscripcion"
  ];
  ...
  */
  ...
  function Pintor(canvas, paleta) {
    ...
    */
    this.fuenteIlegible = "mtPhags, mtEgipcio, mtLinearB, mtSign, monospace";
    this._anchos = {};
  ...
  Pintor.prototype.pintar = function (rej, tiempo) {
    ...
    for (var i = 0; i < n; i += 1) {
      ...
      var ilegible = rej.origen[i] === ORIGEN.INSCRIPCION;
      ...
      */
      var glifo = String.fromCodePoint(code);
