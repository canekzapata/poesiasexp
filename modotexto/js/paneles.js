...
(function (root) {
  ...
  var DEFINICIONES = {
    CAMARA:      { titulo: "CAMARA",  facultad: "la vista" },
    PLANTA:      { titulo: "PLANTA",  facultad: "la memoria cartográfica" },
    REGISTRO:    { titulo: "REGISTRO", facultad: "la narración" },
    INSPECTOR:   { titulo: "INSPECTOR", facultad: "el nombre de las celdas" },
    PROFUNDIDAD: { titulo: "↕", facultad: "la medida del fondo" }
  };
