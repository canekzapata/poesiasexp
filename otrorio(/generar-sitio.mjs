...
].concat(NAHUATL.fragments, POLYGLOT.englishJourney, POLYGLOT.frenchTongues, POLYGLOT.portugueseCurrent);
const MICRO = [
...
].concat(NAHUATL.passages, POLYGLOT.englishJourney, POLYGLOT.portugueseCurrent);
const DIAGRAM_TEXT = [
...
].concat(NAHUATL.passages, POLYGLOT.englishJourney, POLYGLOT.frenchTongues, POLYGLOT.portugueseCurrent);
...
<body class="relic-codex-page"><header class="relic-codex-header"><p class="micro" lang="nah">AMOXTLI / ΛΕΊΨΑΝΟΝ / TLAHTOLLI</p><h1>códice de reliquias</h1><p>No son puntos ni aparecen por entrar. Son frases, residuos y pequeñas pruebas que un gesto encontró sin saber que las buscaba.</p><nav><a class="route" href="index.html?seed=${encodeURIComponent(WORLD_SEED)}">volver al río</a><a class="route" href="mapa.html?seed=${encodeURIComponent(WORLD_SEED)}&amp;view=used">mapa que aún omite</a><a class="route" href="acontecimientos.html?seed=${encodeURIComponent(WORLD_SEED)}">acontecimientos / PDF</a></nav></header><main id="relic-codex" class="relic-codex" aria-live="polite"></main><footer class="relic-sources"><p>Las formas en náhuatl clásico y griego antiguo llevan glosas editoriales propias en español. Los fragmentos griegos siguen la numeración Diels–Kranz.</p><a href="https://historicas.unam.mx/publicaciones/publicadigital/libros/obras_leon_portilla/339/339_04_08_apendicei.pdf">Cantares mexicanos / textos citados en su original náhuatl · UNAM</a><a href="https://gdn.iib.unam.mx/">Gran Diccionario Náhuatl · UNAM</a><a href="https://archive.org/details/fragmentsofworko00hera">Fragmentos de Heráclito / edición griega de Bywater</a><a href="https://orb.binghamton.edu/sagp/253/">Heraclitus: The River Fragments / Binghamton University</a></footer><script>addEventListener('DOMContentLoaded',function(){LabRelics.render(document.getElementById('relic-codex'))});</script></body></html>`;
}
...
const manifest = {
  ...
  relics: "gesture-only seed-local codex, never a score",
  entrySeed: "fresh random seed when index has no seed query",
  languageCharacters: { en: "journey and UX/UI commentator", fr: "tongue-twister engine", pt: "Sousândrade-inspired typographic current", grc: "relic stratum" },
  nahuatl: { variety: NAHUATL.variety, sources: NAHUATL.sources },
  ancientGreek: { source: "Heraclitus fragments, Diels-Kranz B12/B60/B119/B123", glosses: "Spanish, editorial" },
