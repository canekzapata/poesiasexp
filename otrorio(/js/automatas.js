(function (global) {
  ...
  function dimensions(canvas) {
    ...
    return {
      width: Math.max(120, Number(canvas.dataset.width) || canvas.clientWidth || rect.width || global.innerWidth),
      height: Math.max(90, Number(canvas.dataset.height) || canvas.clientHeight || rect.height || global.innerHeight)
    };
  }
