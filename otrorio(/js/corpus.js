...
`       00000100000
    ...
    griegoAntiguo: {
      variedad: "griego antiguo / fragmentos de Heráclito en numeración Diels–Kranz",
      fragmentos: [
        { grc: "ποταμοῖσι τοῖσιν αὐτοῖσιν ἐμβαίνουσιν ἕτερα καὶ ἕτερα ὕδατα ἐπιρρεῖ.", es: "Para quienes entran en los mismos ríos, fluyen unas y otras aguas.", fuente: "Heráclito, DK B12" },
        { grc: "ὁδὸς ἄνω κάτω μία καὶ ὡυτή.", es: "El camino hacia arriba y hacia abajo es uno y el mismo.", fuente: "Heráclito, DK B60" },
        { grc: "φύσις κρύπτεσθαι φιλεῖ.", es: "La naturaleza ama ocultarse.", fuente: "Heráclito, DK B123" },
        { grc: "ἦθος ἀνθρώπῳ δαίμων.", es: "El carácter es para el ser humano su destino.", fuente: "Heráclito, DK B119" }
      ],
      palabras: [
